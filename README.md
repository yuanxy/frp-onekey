...
```Bash
wget https://raw.githubusercontent.com/yuanxy/frp-onekey/master/install-frps.sh -O ./install-frps.sh
...
v0.34.3
@github-actions github-actions released this on 20 Nov · 13 commits to dev since this release
 ...
 * ## v0.28.2
@fatedier fatedier released this 6 days ago
