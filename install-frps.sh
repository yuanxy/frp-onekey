...
str_install_shell="https://raw.githubusercontent.com/yuanxy/frp-onekey/master/install-frps.sh"
shell_update(){
    fun_clangcn "clear"
...
fun_clangcn(){
    ...
    echo ""
    echo "+------------------------------------------------------------+"
    echo "|   frps for Linux Server, Author 网络一哥 ，Mender 51妹子网     |" 
...
fun_download_file(){
    ...
    if [ ! -s ${str_program_dir}/${program_name} ]; then
        ...
        echo -e "wget  -q ${program_latest_file_url} -O ${program_latest_filename}"
